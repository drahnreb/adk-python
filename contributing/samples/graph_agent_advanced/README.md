...
print(session.state.get("graph_state"))  # Partial state saved
```
...
- **Design**: `contributing/docs/graph_agent_design.md`
- **Interrupt Service**: `contributing/docs/interrupt_service_architecture.md`
- **Checkpoint Service**: `contributing/docs/checkpoint_service_architecture.md`
- **Future Enhancements**: `contributing/docs/future_enhancements_plan.md`
- **Basic Example**: `contributing/samples/graph_agent_basic/agent.py`
